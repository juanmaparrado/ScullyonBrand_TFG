...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="offer top">
            <h1 id="shipping">WELCOME TO SCULLYON -  WELCOME TO SCULLYON - WELCOME TO SCULLYON </h1>
        </div>
        ...
        <div class="offer white">
            <h1 id="welcome">NEW DROP AVAILABLE NOW - 06/2023 - NEW DROP AVAILABLE NOW - 06/2023 </h1>
        </div>
        ...
        <section class="services">
            <div class="row">
                <div class="servi">
                    ...
                    <p>Worlwide Shipping with Scullyon</p>   
                </div>
                <div class="servi">
