        ...
        <div class="create">
            <form action="{{ route('reviews.store') }}" method="POST" class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" id="title" class="form-input mt-1 block w-full" placeholder="Enter title" required>
                </div>

                <div class="mb-4">
                    <label for="body" class="block text-sm font-medium text-gray-700">Text of Review</label>
                    <input type="text"name="body" id="body" class="form-input mt-1 block w-full" placeholder="Enter a review" required>
                </div>
